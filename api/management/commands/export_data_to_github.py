...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        data_update_branch_name = f"data-update-{current_date_string}-test"
        ...
        #     branch_name=data_update_branch_name,
        # )
        old_frontend_constants_file = utilities_github.get_file(
        ...
        new_frontend_constants_file_content = utilities.update_frontend_last_updated_datetime(
            old_frontend_constants_file.decoded_content.decode(),
